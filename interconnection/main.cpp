...
EXPORT CLASS *init(CALLBACKS *fntable, MODULE *module, int argc, char *argv[])
{
	...
	gl_global_create("interconnection::nominal_frequency[Hz]",
		PT_double,&nominal_frequency, 
		PT_ACCESS,PA_PUBLIC,PT_UNITS,"Hz",
		NULL);
	gl_global_create("interconnection::minimum_frequency[Hz]",
		PT_double,&minimum_frequency,PT_UNITS,"Hz",
		PT_ACCESS,PA_PUBLIC,
		NULL);
	gl_global_create("interconnection::maximum_frequency[Hz]",
		PT_double,&maximum_frequency,PT_UNITS,"Hz",
		PT_ACCESS,PA_PUBLIC,
		NULL);
	gl_global_create("interconnection::droop_control[pu]",
		PT_double,&droop_control,
		PT_ACCESS,PA_PUBLIC,
		NULL);
	gl_global_create("interconnection::lift_control[pu]",
		PT_double,&lift_control,
		PT_ACCESS,PA_PUBLIC,
		NULL);
	gl_global_create("interconnection::frequency_bounds",
		...
		NULL);
	gl_global_create("interconnection::solver_check",
		PT_char1024,&solver::solver_check,
		PT_ACCESS,PA_PUBLIC,
		NULL);
	gl_global_create("interconnection::trace_messages",
		...
		NULL);
	gl_global_create("interconnection::verbose_options",
